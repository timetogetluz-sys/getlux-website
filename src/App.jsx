    ...
    <div className="min-h-screen font-sans bg-white text-gray-900">
        ...
        <div className="max-w-6xl mx-auto px-6 py-12 flex items-center justify-between">
          <div>
            ...
            <p className="mt-2 text-lg md:text-xl">
              Caribbean-inspired dance & fitness — Island energy for every body.
            </p>
            <div className="mt-6 flex gap-3">
              <a href="#classes" className="px-5 py-3 bg-white rounded-2xl shadow font-medium">
                See Classes
              </a>
              <a href="#book" className="px-5 py-3 border border-white rounded-2xl font-medium">
                Book a Private
              </a>
            </div>
          </div>
      ...
      <section id="about" className="max-w-6xl mx-auto px-6 py-12">
        ...
        <p className="mt-3 text-lg leading-relaxed">
          GETLUZ blends Caribbean bashment, dancehall, afrobeats, amapiano and NYC flavor into
          beginner-friendly fitness classes, freestyle sessions, and curated showcases. We teach
          movement, confidence, and community — whether you’re new to dance or a freestyler looking
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-5 bg-white rounded-lg shadow">
              ...
              <p className="mt-2">
                High-energy Caribbean fitness class. Soca + Dancehall + Amapiano. Great for
                beginners.
              </p>
            ...
            <div className="p-5 bg-white rounded-lg shadow">
              ...
              <p className="mt-2">
                Freestyle party session with live DJ, creative prompts, and video capture for
                promos.
              </p>
            ...
            <div className="p-5 bg-white rounded-lg shadow">
              ...
              <p className="mt-2">
                1:1 coaching for choreography, casting prep, and fitness goals.
              </p>
      ...
      <section id="gallery" className="max-w-6xl mx-auto px-6 py-12">
        ...
        <p className="mt-3">
          Live feed from Instagram (connect your account to show photos/videos here).
        </p>
      ...
      <section id="merch" className="bg-gradient-to-t from-yellow-50 to-white py-12">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <p className="mt-3">
            Branded shorts, sweat towels, bandanas — perfect for classes and giveaways. Link to shop
            or add simple buy buttons here.
          </p>
        </div>
      </section>
      ...
      <section id="book" className="max-w-6xl mx-auto px-6 py-12">
        ...
        <p className="mt-3">
          For class signups, private sessions, collabs, and bookings: DM{' '}
          <a href="https://instagram.com/timetogetluz" className="text-pink-600 font-medium">
            @timetogetluz
          </a>{' '}
          or email{' '}
          <a href="mailto:hello@timetogetluz.com" className="text-pink-600 font-medium">
            hello@timetogetluz.com
          </a>.
        </p>
      </section>
      ...
      <footer className="bg-gray-900 text-white py-8">
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="mt-4 md:mt-0">
            <a href="https://instagram.com/timetogetluz" className="mr-4">
              Instagram
            </a>
            <a href="#">Privacy</a>
          </div>
